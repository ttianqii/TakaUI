...
// Note: DataGrid is a new advanced component - see DataGridPage for examples
// import { DataGrid, DataGridTable, DataGridPagination } from '../components';
  ...
  const styledColumns: DataTableColumn<Product>[] = [
    {
      key: 'name',
      header: 'Product Name',
      cell: (value) => <span className="font-semibold text-slate-900">{value as React.ReactNode}</span>,
    },
    {
      key: 'category',
      header: 'Category',
